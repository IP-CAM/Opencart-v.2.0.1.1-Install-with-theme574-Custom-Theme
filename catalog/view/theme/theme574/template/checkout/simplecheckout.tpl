    ...
    <div id="simplecheckout_form_<?php echo $group ?>" <?php echo $display_error && $has_error ? 'data-error="true"' : '' ?> <?php echo $logged ? 'data-logged="true"' : '' ?>>
        <div class="simplecheckout">
            <?php if (!$cart_empty) { ?>
                ...
                <?php } ?>
                <div class="simplecheckout-button-block buttons" id="buttons" style="background: transparent; padding-left: 0">
            ...
            <?php } else { ?>
                ...
                <?php } ?>
                <div class="simplecheckout-button-block buttons" style="background: transparent; padding-left: 0">

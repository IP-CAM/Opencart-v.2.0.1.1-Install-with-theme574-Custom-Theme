  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  ...
	  <div class="buttons">
	  	...
	  	function goalButtonOrder(){
	  		yaCounter45763188.reachGoal('BUTTON_ORDER');
	  		ga('send', 'event', 'cart', 'button_order');
	  	}
	  	</script>
		<div class="pull-left"><a href="<?php echo $continue; ?>" class="btn btn-default"><?php echo $button_shopping; ?></a></div>
		<div class="pull-right"><a href="<?php echo $checkout; ?>" class="btn btn-primary" onclick="goalButtonOrder();"><?php echo $button_checkout; ?></a></div>
	  </div>

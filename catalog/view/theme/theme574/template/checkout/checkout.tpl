...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?>" style="    text-align: center;"><?php echo $content_top; ?>
  
     <h1><p style="text-align: center;">Спасибо за покупку!<br>Ваш заказ сформирован!</p></h1>

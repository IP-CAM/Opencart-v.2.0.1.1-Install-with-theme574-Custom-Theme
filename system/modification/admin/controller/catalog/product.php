...
$data['all_options'] = $this->model_catalog_image_option->getAllOptions();

if(isset($this->request->get['product_id'])) {
  $data['product_images_options'] = $this->model_catalog_image_option->getImagesOptionsByProductId($this->request->get['product_id']);
} else {

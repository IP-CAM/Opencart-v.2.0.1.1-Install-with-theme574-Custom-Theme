    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br /><br />  
              ...
              <div class="form-group">
						<label class="col-sm-2 control-label" for="input-entry_1">Сумма скидки</label>
						<div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-option">
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="option" style="width: 100%;border: none;">
                    <?php $option_row = 0; ?>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <td class="text-left"><div class="image">
                <?php if ($all_options) { ?>
                ...
                <?php } ?>      
                <br /><br />
                <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
...
function addImage() {
  ...
  html += '      <a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';

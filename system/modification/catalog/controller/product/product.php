...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
          ...
          $var_currency_fastorder = array();
          $var_currency_fastorder['value'] = $this->currency->getValue();
          $var_currency_fastorder['symbol_left'] = $this->currency->getSymbolLeft();
          $var_currency_fastorder['symbol_right'] = $this->currency->getSymbolRight();
          $var_currency_fastorder['decimals'] = $this->currency->getDecimalPlace();
          $var_currency_fastorder['decimal_point'] = $this->language->get('decimal_point');
          $var_currency_fastorder['thousand_point'] = $this->language->get('thousand_point');
          $data['currency'] = $var_currency_fastorder;      

...
<div style="width: 100%;display: inline-block;" class="">
		  <ul class="box-subcat" style="width: 100%;display: inline-block;text-align: center;">
			...
			<li class="col-xs-4 <?php echo $a. $last_line ;?>">
	  ...
	  <div class="row">
		...
		<div class="col-sm-2 hidden-xs">
			<div class="image">
				<img src="<?php echo $thumb; ?>" alt="" title="" class="img-thumbnail" />
			</div>
		</div>
		<?php } ?>
		<?php if ($description) { ?>
		  <div class="col-sm-10"><div style="text-align: justify;line-height: 1.8;font-size: 12.0pt;font-family: 'times new roman';color:#2d2e42;"><?php echo $description; ?></div></div>
		<?php } ?>
	  </div>
	  <br><br>
	  <?php } ?>
	  <?php if ($categories) { ?>
	  <h3 class="hidden-xs" style="text-align: center">Что Вас интересует?</h3>
		...
		<!--<div class="nav-cat clearfix">
			...
			<div class="pull-right">
				<a href="<?php echo $compare; ?>" id="compare-total">
					<span style="line-height: 0px;position:relative;top:-1px;"><?php echo $text_compare; ?></span>
			...
			<div>
			  <div class="caption">
				...
				<div class="cart-button">
					<button class="product-btn-add" type="button" onclick="fastorder_open('<?php echo $product['product_id']; ?>');"><i style="color:#ffffff;" class="fa fa-bolt"></i> <span class="hidden-sm">Купить</span></button>
					<div class="row">
						<button class="product-btn" type="button" title="В корзину" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="material-design-shopping231"></i></button><button class="product-btn" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="material-design-shuffle24"></i></button><a class="product-btn" data-toggle="tooltip" title="<?php echo $text_details; ?>" href="<?php echo $product['href']; ?>"><i class="material-design-right244"></i></a>
					</div>

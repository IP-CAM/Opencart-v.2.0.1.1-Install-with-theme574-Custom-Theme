...
<div class="product-share" style="width: auto;">
	<div style="float: left; display: inline-block; width: 87px;">
	...
	<div style="float: left; display: inline-block; width: 88px;" >
		<div style="display: block; float: left;" class="fb-like" data-href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
	</div>
	<div style="float: left; display: inline-block; width: 65px;">
		<!-- Поместите этот тег туда, где должна отображаться кнопка "Поделиться". -->
		<div class="g-plusone" data-size="medium"></div>
	</div>
	<div style="float: left; display: inline-block;padding-left: 3px;">
		<a class="addthis_counter addthis_pill_style"></a>
		<style>@media screen and (max-width: 600px) { .addthis_counter a.atc_s {color: #fe6d4c;width: 20px;}.addthis_counter.addthis_pill_style a.addthis_button_expanded{float:none;}}</style>
